Semi-automated grading workflow
================

This is not an actual R package, just some utility functions and this
Rmd file.

The intended use is for you to modify this Rmd-file so it fits your
exam, run the chunks interactively, and then paste the relevant outputs
into your lecture homepage and the template spreadsheet
“Notenliste”-files for the grades.
...
Then compute grades and identify borderline cases (skip this if your
